...
import 'statistique_journalier_employe_centre_credit.dart';
import 'statistique_journalier_employe_centre_credit_produit.dart';
import 'statistique_journalier_employe_centre_produit.dart';
import 'statistique_journalier_employe_centre_produit_tee_shirt.dart';
import 'statistique_journalier_employe_centre_tee_shirt.dart';
import 'statistique_journalier_general_employe_centre.dart';
import 'statistique_joutrnalier_employe_centre_credit_tee_shirt.dart';
...
class StatistiqueJournalierEmployeCentre extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (nbre_vente_credit > 0 &&
        nbre_vente_produit <= 0 &&
        nbre_vente_tee_shirt <= 0) {
      return StatistiqueJournalierEmployeCentreCredit();
    }

    if (nbre_vente_credit <= 0 &&
        nbre_vente_produit > 0 &&
        nbre_vente_tee_shirt <= 0) {
      return StatistiqueJournalierEmployeCentreProduit();
    }

    if (nbre_vente_credit <= 0 &&
        nbre_vente_produit <= 0 &&
        nbre_vente_tee_shirt > 0) {
      return StatistiqueJournalierEmployeCentreTeeShirt();
    }

    if (nbre_vente_credit > 0 &&
        nbre_vente_produit > 0 &&
        nbre_vente_tee_shirt <= 0) {
      return StatistiqueJournalierEmployeCentreCreditProduit();
    }

    if (nbre_vente_credit > 0 &&
        nbre_vente_produit <= 0 &&
        nbre_vente_tee_shirt > 0) {
      return StatistiqueJournalierEmployeCentreCreditTeeShirt();
    }

    if (nbre_vente_credit <= 0 &&
        nbre_vente_produit > 0 &&
        nbre_vente_tee_shirt > 0) {
      return StatistiqueJournalierEmployeCentreProduitTeeShirt();
    }

    return StatistiqueJournalierGeneralEmployeCentre();
  }
}
