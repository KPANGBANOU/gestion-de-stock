...
class RubriqueProduit extends StatelessWidget {
  RubriqueProduit({super.key});
  ...
  Widget build(BuildContext context) {
    final _listgrandmodel = Provider.of<List<products>>(context);
              ...
              SizedBox(
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: ((context, index) {
                      products _donnes = _listgrandmodel[index];
