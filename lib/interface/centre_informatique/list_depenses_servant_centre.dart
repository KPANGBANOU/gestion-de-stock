...
import 'stream_depense_seravnt_centre.dart';

class ListDepenseServantCentre extends StatelessWidget {
  const ListDepenseServantCentre({super.key});
              ...
              return ListTile(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: ((context) => StreamDepenseServantCentre(
