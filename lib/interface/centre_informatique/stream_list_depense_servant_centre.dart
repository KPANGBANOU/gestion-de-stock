...
import 'list_depenses_servant_centre.dart';

class StreamListDepenseServantCentre extends StatelessWidget {
      ...
      providers: [
        ...
        StreamProvider(
            create: ((context) => context
                .read<serviceBD>()
                .list_depense_centre(_utilisateur.uid)),
            initialData: <DepenseCentre>[]),
      ],
      child: ListDepenseServantCentre(),
    );
  }
}
