...
import 'list_probleme_servant_bar.dart';

class StreamListProblemeServantBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        StreamProvider(
            create: ((context) =>
                context.read<serviceBD>().list_probleme_bar(_utilisateur.uid)),
            initialData: <probleme>[]),
      ],
      child: ListProblemeServantBar(),
    );
  }
}
