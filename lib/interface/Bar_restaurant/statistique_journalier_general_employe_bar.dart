...
class StatistiqueJournalierGeneralEmployeBar extends StatelessWidget {
  StatistiqueJournalierGeneralEmployeBar({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "statistique journalier de vente de l'employé "
                          .toUpperCase() +
              ...
              Container(
                ...
                child: Text(
                  "Vente de pétit modèle".toUpperCase(),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
              ...
              Container(
                ...
                color: Colors.redAccent.withOpacity(.7),
                child: Text(
                  "Vente de grand modèle".toUpperCase(),
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 20,
