...
import 'list_depenses_servant_bar.dart';

class StreamListDepenseServantBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        StreamProvider(
            create: ((context) =>
                context.read<serviceBD>().list_depenses_bar(_utilisateur.uid)),
            initialData: <donnesDepense>[]),
      ],
      child: ListDepenseServantBar(),
    );
  }
}
