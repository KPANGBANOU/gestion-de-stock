...
class RubriqueVersement extends StatelessWidget {
  RubriqueVersement({Key? key}) : super(key: key);

  final _vente = FirebaseFirestore.instance.collectionGroup("ventes");

  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: _vente.snapshots(),
