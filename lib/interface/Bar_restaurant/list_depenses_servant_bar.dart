...
import 'stream_depense_servant_bar.dart';

class ListDepenseServantBar extends StatelessWidget {
  const ListDepenseServantBar({super.key});
              ...
              return ListTile(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: ((context) => StreamDepenseServantBar(
