...
class StatistiquePetitModeleCredit extends StatelessWidget {
  StatistiquePetitModeleCredit({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final _listVente = Provider.of<List<ventePetitModele>>(context);
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                        ...
                        physics: ScrollPhysics(),
                        itemBuilder: ((context, index) {
                          ventePetitModele _vente = _listVente[index];
