...
class ventePetitModele {
  ...
  @override
  String toString() {
    return 'ventePetitModele(uid: $uid, quantite: $quantite, montant: $montant, nom_bierre: $nom_bierre, category: $category, benefice: $benefice, date_vente_day: $date_vente_day, date_vente: $date_vente, date_vente_month: $date_vente_month)';
  }
