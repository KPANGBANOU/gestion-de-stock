...
class Centreventeteeshirts {
  ...
  factory Centreventeteeshirts.fromfirestore(DocumentSnapshot document) {
    return Centreventeteeshirts(
  ...
  factory Centreventeteeshirts.fromMap(Map<String, dynamic> map) {
    return Centreventeteeshirts(
      uid: map['uid'] ?? '',
  ...
  factory Centreventeteeshirts.fromJson(String source) =>
      Centreventeteeshirts.fromMap(json.decode(source));

  @override
  String toString() {
    return 'Centreventeteeshirts(uid: $uid, quantite: $quantite, montant: $montant, nom_tee_shirts: $nom_tee_shirts, qualite: $qualite, benefice: $benefice, date_vente: $date_vente, date_vente_day: $date_vente_day, date_vente_month: $date_vente_month)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is Centreventeteeshirts &&
        other.uid == uid &&
