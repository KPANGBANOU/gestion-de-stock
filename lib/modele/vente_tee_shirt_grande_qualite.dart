...
class venteteeshirtsgrandequalite {
  ...
  @override
  String toString() {
    return 'venteteeshirtsgrandequalite(uid: $uid, quantite: $quantite, montant: $montant, nom_tee_shirts: $nom_tee_shirts, qualite: $qualite, benefice: $benefice, date_vente: $date_vente, date_vente_day: $date_vente_day, date_vente_month: $date_vente_month)';
  }
